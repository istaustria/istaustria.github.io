...
code:
   - name: Source Code (paper release) 
     link: https://git.ista.ac.at/yichen/primal-dual-friction-public
   - name: Source Code (newer version) 
     link: https://git.ista.ac.at/wojtan-group/yi-lu-chen/frictionfrenzy
